...
parser.add_argument('--model-path', type=str, default="runs/train/baseline/yolov5l_Add_FLIR-align-3class-80/weights/best.pt", help='Path to the model')
...
parser.add_argument('--output-dir', type=str, default='visualization/FLIR-align-3class/baseline', help='output dir')
    ...
    if args.method == 'gradcam':
        for layer in args.target_layer:
            ...
            if(len(heat) != 0):
                ...
                res_img = cv2.addWeighted(res_img, 0.2, heat_avg, 0.8, 0)
            res_img = (res_img / res_img.max())
...
if __name__ == '__main__':
    if os.path.isdir(args.source1):
        ...
        img_vis_list.sort()
        for item in img_vis_list[500:501]:
