...
import test  # import test.py to get mAP after each resume
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/ssf/VEDAI/yolov5l_Mambafusionall_VEDAI.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/multispectral/VEDAI04.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/train/VEDAI', help='save to project/name')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--name', default='yolov5l_Mambafusionall_VEDAI04', help='save to project/name')
