...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/transformer/Mamba_Transfusion_FLIR.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='runs/train/FLIR-align-3class', help='save to project/name')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--name', default='VSS_SSF_FLIR-align-3class', help='save to project/name')
