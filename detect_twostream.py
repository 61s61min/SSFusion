...
def detect(opt):
    ...
    for (path, img, im0s, vid_cap), (path_, img2, im0s_, vid_cap_) in zip(dataset, dataset2):
        ...
        pred = model(img.half(), img2.half(), augment=opt.augment)[0]
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # #
            # # ---------------------------------------------------------------------------
            # annoPath = "/home/shen/Chenyf/FLIR-align-3class/labels/test/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/bestmodel/yolov5l_Mambafusion_FLIR-align-3class-83/best.pt', help='model.pt path(s)')
