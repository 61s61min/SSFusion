...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            # Run model
            t = time_synchronized()
            out, _, train_out = model(img_rgb.half(), img_ir.half(), augment=augment)  # inference and training outputs
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/VEDAI/yolov5l_Mambafusionall_VEDAI03-816/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/multispectral/VEDAI04.yaml', help='*.data path')
    ...
    parser.add_argument('--name', default='yolov5l_Concatmambafusin_M3FD', help='save to project/name')
    ...
    p = "/home/shen/Chenyf/VEDAI/fold04/labels/test"
